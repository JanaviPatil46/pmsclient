  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (loginResult.status === 200) {
        ...
        // Store user data for potential selection in dashboard
        // if (loginResult.userList && loginResult.userList.length > 1) {
        //   localStorage.setItem("pendingUserSelection", JSON.stringify({
        //     userList: loginResult.userList,
        //     email: email
        //   }));
        // }
