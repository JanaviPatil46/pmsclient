...
// import { styled } from "@mui/material/styles";
// import { toast } from "material-react-toastify";
// import { InputAdornment, IconButton, Fade, Menu, MenuItem, Checkbox, FormControlLabel } from "@mui/material";
...
//   useEffect(() => {
//     const token = sessionStorage.getItem("clientdatatoken") || Cookies.get("clientuserToken");
//     if (token) {
//       verifyToken(token);
//     }
//   }, []);
...
//     try {
//       const verifyUrl = `${LOGIN_API}/common/clientlogin/verifytoken`;
...
//     // Use session-based cookie if rememberMe is not checked
//     const expiryTime = rememberMe ? 8 * 60 * 60 : 0;
...
//       if (loginResult.status === 200) {
//         if (rememberMe) {
//           // Use localStorage and persistent cookie for "remember me"
//           localStorage.setItem("clientdatatoken", loginResult.result.token);
//           Cookies.set("clientuserToken", loginResult.result.token, { expires: 7 }); // 7 days
//         } else {
//           // Use sessionStorage and session cookie
//           sessionStorage.setItem("clientdatatoken", loginResult.result.token);
//           Cookies.set("clientuserToken", loginResult.result.token, { expires: 0 });
//         }
