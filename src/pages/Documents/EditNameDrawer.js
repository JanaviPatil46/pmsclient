...
useEffect(() => {
  ...
  const handleRename = async () => {
    ...
    try {
      await onRename(item, newName, itemPath);
    } finally {
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-50 h-full w-full max-w-xs bg-background border-l border-border shadow-xl flex flex-col"
          >
            {/* Header */}
